-1"Loading fits lib extension functions from qfits.so.";

.astro.listHDUs:`qfits 2:(`listHDUs;1);
.astro.getFitsRowCount:`qfits 2:(`num_rows;2);
.astro.getFitsColCount:`qfits 2:(`num_cols;2);
.astro.getFitsColNames:`qfits 2:(`cols;2);
.astro.getFitsColType:`qfits 2:(`getColType;3);
.astro.readLongCol:`qfits 2:(`readLongCol;4);
.astro.readDoubleCol:`qfits 2:(`readDoubleCol;4);
.astro.readIntCol:`qfits 2:(`readIntCol;4);
.astro.readSymCol:`qfits 2:(`readSymCol;4);
