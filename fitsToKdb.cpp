...
*/               
QFITS_API K K_DECL num_rows(K x, K y)
{
  fitsfile *fptr;
  long nrows;
...
*               y - int representing the HDU of the binary table
*/               
QFITS_API K K_DECL num_cols(K x, K y)
{
  fitsfile *fptr;
...
*/               
QFITS_API K K_DECL cols(K x, K y)
{
  fitsfile *fptr;
...
*/               
QFITS_API K K_DECL getColType(K x, K y, K z)
{
  fitsfile *fptr;
...
*/
QFITS_API K K_DECL readLongCol(K x,K y,K z,K h)
{
  fitsfile *fptr;
  //long long arr[z->j];
  long long* arr = new long long[z->j];
  int colnum=0;
...
QFITS_API K K_DECL readIntCol(K x,K y,K z,K h)
{
  fitsfile *fptr;
  //int arr[z->i];
  int* arr = new int[z->i];
...
QFITS_API K K_DECL readDoubleCol(K x,K y,K z,K h)
{
  fitsfile *fptr;
  // double arr[z->i];
  double* arr = new double[z->i];
  int colnum=0;
  int status=0,hdunum,hdutype,anynulls,i;
  float nullval;
  K list=ktn(KF,0);
...
QFITS_API K K_DECL readSymCol(K x,K y,K z,K h)
{
  fitsfile *fptr;
